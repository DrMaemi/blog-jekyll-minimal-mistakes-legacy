...
<p align="center">
  <figure>
    <img src="https://drive.google.com/uc?export=view&id=1FdSXpvQKyCVjyo5JKjEeqNqTCz7RaLVY" alt="파이썬 파일 생성" style="width: 75%" text-align="center">
    <figcation align="center">파이썬 파일 생성</figcation>
  </figure>
</p>

![파이썬 파일 생성](https://drive.google.com/uc?export=view&id=1FdSXpvQKyCVjyo5JKjEeqNqTCz7RaLVY){: .align-center}
파이썬 파일 생성
{: style="text-align: center;"}

{% include figure image_path="https://drive.google.com/uc?export=view&id=1FdSXpvQKyCVjyo5JKjEeqNqTCz7RaLVY" alt="파이썬 파일 생성" caption="파이썬 파일 생성" %}{: .align-center}
